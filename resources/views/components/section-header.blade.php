...
<div id="{{ $id }}" class="text-center max-w-3xl mx-auto mb-12 px-4 mt-16" >
    ...
    <p class="text-xs md:text-sm text-cyan-600 dark:text-cyan-400 font-medium opacity-90 dark:opacity-80">
        {{ $description }}
    </p>
</div>