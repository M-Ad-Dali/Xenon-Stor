...
<div class="relative inline-block text-left self-center z-150 rtl:text-right ltr:text-left" x-data="{ open: false }"
    ...
    <button @click="open = ! open" type="button"
        class="flex items-center p-1 rounded-full bg-slate-200/50 dark:bg-slate-800/50 backdrop-blur-md border border-slate-300/40 dark:border-slate-700/50 hover:border-purple-500 hover:scale-105 transition-all duration-300 group cursor-pointer">
        <div
    ...
    <div x-show="open" style="display: none;" @click.away="open = false" @click.stop.immediate
        ...
        class="absolute z-160 mt-2 p-5 w-70 max-w-[85vw] bg-white dark:bg-slate-900/95 backdrop-blur-2xl rounded-4xl shadow-2xl border border-slate-100 dark:border-slate-700/50 ltr:origin-top-right rtl:origin-top-left ltr:right-0 rtl:left-0">
        ...
        <hr class="my-4 border-slate-100 dark:border-slate-700/40">
        ...
        {{-- جـ. زر تسجيل الخروج --}}
        @auth
            <div class="mt-5 pt-4 border-t border-slate-100 dark:border-slate-700/40 text-center">
